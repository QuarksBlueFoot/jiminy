...
Linear + cliff vesting, stepped schedules, periodic unlock, claimable amount
calculation.
...
Also has `unlocked_at_step` for discrete step schedules and `elapsed_steps`
for counting complete periods.
